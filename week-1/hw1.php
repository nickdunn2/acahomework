...
foreach ($integerIDs as $key => $var) {
    $integerIDs[$key] = (int)$var;
}
...
foreach ($num_numeric as $key => $var) {
    $num_numeric[$key] = (int)$var;
}

foreach ($num_string as $key => $var) {
    $num_string[$key] = (int)$var;
}

foreach ($num_bool as $key => $var) {
    $num_bool[$key] = (int)$var;
}
